...
describe('buildPass1Prompt', () => {
  const base = {
    ...
    content: 'Agency proposes changes to enforcement procedures',
    docType: 'Rule',
  ...
  it('truncates content to 8000 characters', () => {
    ...
    // The summary in the prompt should be at most 8000 chars of the original
