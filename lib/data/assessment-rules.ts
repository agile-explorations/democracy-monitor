  ...
  lawEnforcement: {
    keywords: {
      capture: [
        ...
        'prosecution dropped for political reasons',
        'attorney general ordered prosecution',
        'doj independence violated',
        'political targeting by doj',
      ],
      drift: [
        'political interference in prosecution',
        'prosecution priorities shifted',
        'enforcement action dropped',
        'doj leadership overruled career staff',
        'sentencing recommendation overridden',
        'investigation closed prematurely',
        'prosecutorial discretion expanded',
        'plea deal reversed by leadership',
      ],
      warning: [
  ...
  civilLiberties: {
    keywords: {
      ...
      drift: [
        ...
        'civil liberties oversight weakened',
        'surveillance expanded',
        'detention authority broadened',
        'religious liberty exemption expanded',
        'protest restricted',
