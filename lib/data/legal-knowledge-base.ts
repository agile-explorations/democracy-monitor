...
export const LEGAL_KNOWLEDGE_BASE: LegalDocument[] = [
  ...
  },
  {
    ...
    content: 'The Posse Comitatus Act prohibits the use of the Army (and by extension, the Air Force) as a posse comitatus or otherwise to execute the laws, except in cases authorized by the Constitution or Act of Congress. Violations are a federal crime. The Act reflects the fundamental principle of civilian control and the separation of military and civilian law enforcement.',
  ...
  },
  {
    ...
    content: 'The Inspector General Act created independent Inspectors General in federal agencies to conduct audits and investigations, promote economy and efficiency, and prevent fraud and abuse. IGs have broad powers including subpoena authority and access to agency records. The President can remove IGs but must communicate the reasons to Congress 30 days in advance. IG independence is considered essential to government accountability.',
  ...
  },
  {
    ...
    content: 'Established the principle of judicial review — the power of federal courts to declare legislative and executive actions unconstitutional. Chief Justice Marshall wrote: "It is emphatically the province and duty of the Judicial Department to say what the law is." This case is the foundation of the courts\' role as a check on executive power.',
  ...
  },
  {
    ...
    content: 'The Supreme Court unanimously held that the President is not above the law and must comply with judicial subpoenas. While recognizing a constitutionally based executive privilege, the Court held it is not absolute and must yield to the demonstrated, specific need for evidence in a criminal proceeding. The case established that the rule of law applies to the President.',
    relevantCategories: ['courts', 'all'],
  },
  {
