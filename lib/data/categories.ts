...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    signals: [
      {
        name: 'GAO Reports (Government Watchdog)',
        url: 'https://www.gao.gov/rss/reports.xml',
        type: 'rss',
        note: 'GAO checks if the government is following money rules',
      },
      {
        name: 'Impoundment News',
        url: '/api/federal-register?term=impoundment',
        type: 'federal_register',
        note: 'Reports about the President refusing to spend approved money',
      },
    ],
  },
  {
    ...
    signals: [
      {
        ...
        type: 'rss',
        note: 'Official news from the Pentagon',
      },
      {
