...
export const SOURCE_COVERAGE_MANIFEST = [
  ...
  'Documents), FEC filings, federal bills (LegiScan), and federal OIG reports.',
  'NOT ingested: OMB/OPM memoranda (e.g. M-numbered directives), GAO reports,',
  'agency guidance published only on agency websites, state and local government',
  ...
  'it triggered" — rather than passing over it in silence.',
];
