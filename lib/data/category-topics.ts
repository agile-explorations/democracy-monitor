 ...
 *
 * Many-to-many: a category can appear in multiple policy areas (e.g.
 * executiveOversight maps from both rule_of_law and institutional_independence), and each
...
export const POLICY_AREA_CATEGORIES: Record<PolicyArea, string[]> = {
  rule_of_law: ['judicialIndependence', 'executiveOversight'],
  civil_liberties: ['judicialIndependence', 'executiveActions'],
  elections: ['elections'],
  media_freedom: ['mediaFreedom'],
  institutional_independence: ['rulemaking', 'executiveActions', 'executiveOversight'],
};
