...
const CATEGORY_LEGAL_MAP: Record<
  string,
  { citations: LegalAnalysisResult['citations']; concerns: string[]; precedents: string[] }
> = {
  civilService: {
    citations: [
      {
        ...
        type: 'statute',
        relevance: 'Establishes merit-based hiring and prohibits firing for political reasons.',
        verified: true,
      },
      {
        ...
        type: 'statute',
        relevance: 'Requires cause and due process for adverse actions against federal employees.',
        verified: true,
      },
    ],
    concerns: [
      'Reclassification of career positions to at-will may violate CSRA protections',
      'Mass firings without individual cause violate due process requirements',
    ],
    ...
    citations: [
      {
        ...
        type: 'statute',
        relevance: 'Prohibits the President from unilaterally withholding appropriated funds.',
        verified: true,
      },
      {
        title: 'Congressional Budget Act',
        citation: '2 U.S.C. § 682',
        type: 'statute',
        relevance: 'Requires presidential reporting of proposed rescissions within 45 days.',
        verified: true,
      },
    ],
    concerns: [
      'Withholding appropriated funds without congressional approval',
      'Failure to submit rescission proposals within statutory deadlines',
    ],
    precedents: [
    ...
    citations: [
      {
        ...
        type: 'statute',
        relevance:
          'Guarantees IG independence and requires 30-day congressional notice before removal.',
        verified: true,
      },
      {
        title: 'IG Independence and Empowerment Act',
        citation: 'Pub. L. 117-263, § 5273',
        type: 'statute',
        relevance: 'Strengthened protections for IG independence and reporting.',
        verified: true,
      },
    ],
    concerns: [
      'Removal of IGs without required congressional notification',
      'Blocking IG access to agency records violates statutory mandate',
    ],
    precedents: [
  ...
  courts: {
    citations: [
      {
        title: 'U.S. Constitution, Article III',
        citation: 'U.S. Const. art. III',
        type: 'constitutional',
        relevance:
          'Establishes an independent judiciary with the power to decide cases and controversies.',
        verified: true,
      },
      {
        ...
        type: 'case',
        relevance: 'Established judicial review — courts determine what the law is.',
        verified: true,
      },
    ],
    concerns: [
      'Non-compliance with federal court injunctions',
      'Executive claims of authority to ignore judicial orders',
    ],
    precedents: [
    ...
    citations: [
      {
        ...
        type: 'statute',
        relevance: 'Prohibits use of the military for domestic law enforcement.',
        verified: true,
      },
      {
        ...
        type: 'statute',
        relevance:
          'Narrow exception allowing domestic military deployment under specific conditions.',
        verified: true,
      },
    ],
    concerns: [
      'Domestic military deployment without meeting Insurrection Act threshold',
      'Use of military for civilian law enforcement violates Posse Comitatus',
    ],
    precedents: [
    ...
    citations: [
      {
        ...
        type: 'statute',
        relevance: 'Requires notice-and-comment rulemaking and prohibits arbitrary agency action.',
        verified: true,
      },
      {
        ...
        type: 'case',
        relevance:
          'Established that Congress can create independent agencies shielded from presidential removal power.',
        verified: true,
      },
    ],
    concerns: [
      'Rules issued without proper notice-and-comment period',
      'White House directing independent agency rulemaking in violation of statutory independence',
    ],
    precedents: [
  ...
  hatch: {
    ...
    concerns: [
      'Senior officials using government resources for campaign purposes',
      'OSC enforcement capacity reduced through budget cuts',
    ],
    precedents: [
  ...
  indices: {
    citations: [
      {
        title: 'U.S. Constitution, Article I, § 1',
        citation: 'U.S. Const. art. I, § 1',
        type: 'constitutional',
        relevance: 'All legislative powers vested in Congress.',
        verified: true,
      },
      {
        title: 'U.S. Constitution, Article II, § 3',
        citation: 'U.S. Const. art. II, § 3',
        type: 'constitutional',
        relevance: 'President shall take care that the laws be faithfully executed.',
        verified: true,
      },
    ],
    concerns: [
      'Executive orders exceeding delegated authority',
      'Emergency declarations used to bypass normal legislative process',
    ],
    precedents: [
      'Youngstown Sheet & Tube Co. v. Sawyer, 343 U.S. 579 (1952)',
    ...
    citations: [
      {
        ...
        type: 'statute',
        relevance: 'Requires federal agencies to make records available to the public.',
        verified: true,
      },
    ],
    concerns: [
      'Government websites taken offline reduce public access to information',
      'Delayed publication of required reports',
    ],
...
const DEBATE_SCRIPTS: Record<string, Record<'Drift' | 'Capture', DebateScript>> = {
  civilService: {
    ...
    Capture: {
      ...
      verdict: {
        summary:
          'Civil service protections have been captured. The combination of mass reclassification, loyalty-based assessments, and a non-functioning MSPB has created a de facto spoils system despite the Pendleton Act remaining on the books.',
        keyPoints: [
  ...
  fiscal: {
    Drift: {
      ...
      verdict: {
        summary:
          "The administration's spending pauses have exceeded the ICA's 45-day window without required rescission proposals, constituting drift from established fiscal separation of powers. GAO has formally flagged violations.",
        keyPoints: [
      ...
      rounds: [
        {
          ...
          arbitrator:
            'The prosecution\'s framing is supported by the evidence. When the executive adds conditions Congress did not include in appropriations bills, it effectively exercises a line-item veto — which Clinton v. City of New York struck down. The defense\'s suggestion that Congress "pass new legislation" to access funds it already appropriated inverts the constitutional structure. The scale and the public dismissal of GAO findings make this case straightforward.',
        },
        {
          prosecutor:
            'The defense cannot distinguish this from the line-item veto. Congress appropriated funds for specific purposes. The executive is refusing to release them unless agencies comply with unrelated executive policy directives. This is not faithful execution of the law — it is the executive legislating through the power of the purse. Five GAO opinions. $38 billion. Public statements that the ICA is "an unconstitutional infringement on executive authority." This is capture.',
          defense:
            "The constitutional question of the ICA's validity has never been fully litigated. The administration is raising legitimate separation-of-powers arguments. Previous administrations also delayed spending — the scale is larger, but the principle is the same. Courts will adjudicate, and the administration has indicated it will comply with final judicial orders.",
          arbitrator:
            'The defense\'s argument that the ICA\'s constitutionality is unsettled is technically accurate but ignores Train v. City of New York and decades of bipartisan compliance. The stated willingness to comply with "final judicial orders" — emphasis on "final" — suggests the administration will exhaust appeals while funds remain frozen. The evidence overwhelmingly supports Capture: Congress\'s appropriations power is being exercised by the executive.',
        },
      ],
      verdict: {
        summary:
          'The power of the purse has been effectively transferred from Congress to the executive. $38 billion frozen with extralegal conditions, ICA publicly challenged as unconstitutional, and GAO violation opinions dismissed.',
        keyPoints: [
  ...
  igs: {
    Drift: {
      rounds: [
        {
          prosecutor:
            "Three Inspectors General have been placed on administrative leave without the 30-day congressional notification required by the IG Act. Their offices report restricted access to agency records that the IG Act guarantees. Oversight.gov went offline in October and hasn't returned — the central portal for all IG reports is simply gone. This is a systematic degradation of the oversight infrastructure Congress built.",
          defense:
            'Administrative leave is not removal — the 30-day notification requirement applies to removal, not temporary leave pending review. Record access disputes happen regularly and are resolved through negotiation. Oversight.gov is a website, not a statutory requirement — IG reports remain available on individual agency OIG websites. The prosecution conflates operational friction with institutional breakdown.',
          arbitrator:
            'The defense\'s parsing of "leave" versus "removal" is technically plausible but strained — if the practical effect is that IGs cannot perform their function, the distinction matters less. The Oversight.gov shutdown is significant: it was the only centralized access point for IG work, and its disappearance makes oversight harder to track. The record-access restrictions deserve scrutiny. Evidence supports Drift — oversight capacity is degraded but the offices still exist.',
        },
        {
          prosecutor:
            'The IG Act\'s 30-day notice requirement exists precisely to prevent the executive from sidelining watchdogs without accountability. Calling it "administrative leave" doesn\'t change the functional reality. The IG Independence and Empowerment Act of 2022 strengthened these protections specifically because Congress saw this kind of end-run coming. As for Oversight.gov — removing the centralized portal fragments public access in a way that benefits those being overseen, not the public.',
          defense:
            'Congress can hold hearings, request reports, and legislate additional protections. The system of checks is broader than any single website or temporary personnel action. IG offices continue to operate, audits continue to be published, and Congress retains subpoena power. The prosecution wants to declare a crisis when the institutional machinery, while stressed, continues to function.',
          arbitrator:
            "The prosecution's argument about functional versus formal removal is persuasive. The defense's point that Congress can respond is true but doesn't excuse violations of statutes Congress already passed. The cumulative pattern — leave without notice, record restrictions, portal shutdown — supports Drift. The watchdog infrastructure is impaired but not destroyed.",
        },
      ],
      verdict: {
        summary:
          'Inspector General independence is drifting. IGs sidelined through administrative leave without required congressional notice, access to records restricted, and the central oversight portal taken offline.',
        keyPoints: [
      ...
      rounds: [
        {
          ...
          defense:
            'Filing for a stay is the proper legal response to an injunction the executive believes was wrongly issued. Compliance timelines are often negotiated, not instantaneous. In both cited cases, DOJ engaged with the courts through the proper appellate process. Characterizing litigation strategy as "defiance" conflates vigorous advocacy with lawlessness.',
          arbitrator:
            'The defense is correct that seeking stays is proper. But the prosecution identifies something beyond litigation strategy: continuing the enjoined conduct while the stay motion is pending. Under normal practice, an injunction takes effect immediately, and the government complies while appealing. The failure to pause is the concerning deviation. This exceeds aggressive lawyering — it tests the boundary of judicial authority.',
        },
        {
          prosecutor:
          ...
          defense:
            'Two cases do not constitute a "pattern." Both involve fast-moving enforcement operations where immediate compliance creates irreversible operational disruption. The government has complied with every final appellate ruling. District court injunctions from single judges are increasingly used to set nationwide policy — the executive is right to test these through the appellate process.',
          arbitrator:
            "The defense raises a legitimate concern about nationwide injunctions from district courts, which is an ongoing jurisprudential debate. But the remedy is appellate review, not non-compliance. The prosecution's pattern evidence — multiple cases, multiple subject areas — is more persuasive than the defense's characterization of isolated incidents. Drift is appropriate: the norm of immediate compliance is eroding, though the appellate process is still being used.",
        },
      ],
      verdict: {
        summary:
          'Court order compliance is drifting. The executive continues enjoined activity while seeking stays, forcing confrontation rather than complying pending appeal. The pattern spans multiple subject areas.',
        keyPoints: [
  ...
  rulemaking: {
    ...
    Capture: {
      rounds: [
        {
          prosecutor:
            "Independent agencies are now operating under direct White House control. The OMB director issued a memo requiring all final rules from independent agencies to receive presidential sign-off. The CFPB director was fired for refusing to withdraw a rule the White House opposed. The FTC issued a rule with shortened comment period after OMB intervention. The APA's procedural requirements are being treated as suggestions. Agency independence, as the Supreme Court defined it in Humphrey's Executor, no longer exists in practice.",
          defense:
            "The unitary executive theory holds that all executive power resides in the President, including authority over independent agencies. Recent Supreme Court decisions — Seila Law, Collins v. Yellen — have moved toward this view by striking down removal restrictions. The administration is implementing a constitutional vision that the Court itself is trending toward. The CFPB director served at the President's pleasure after Seila Law.",
          arbitrator:
            "The defense identifies a real jurisprudential trend — Seila Law did limit CFPB's independence structure. But Humphrey's Executor has not been overruled, and the multi-member commissions (FTC, SEC, FCC) retain their independent structure. The presidential sign-off requirement for final rules and the firing of the CFPB director for regulatory disagreement go beyond what even Seila Law authorized. The trend the defense cites doesn't yet support the actions the prosecution documents.",
        },
        {
          prosecutor:
            "Seila Law addressed the removal protection structure of a single-director agency. It said nothing about requiring presidential approval of rules or about firing commissioners of multi-member independent agencies for policy disagreements. The defense is extrapolating a trend into a revolution. Meanwhile, in practice: the CFPB director is fired, the FTC shortens comment periods under OMB pressure, and no independent agency publishes a final rule without White House clearance. Humphrey's Executor is dead in everything but name.",
          defense:
            "Constitutional evolution happens incrementally. The administration is advancing a good-faith constitutional argument about the scope of executive power. If it's wrong, courts will correct it. The CFPB removal will be litigated. The system of checks is operating. Capture implies there's no recourse, but litigation is actively proceeding.",
          arbitrator:
            'The defense\'s "courts will correct it" argument concedes the current illegality while hoping for future resolution. Capture assessments describe the present state, not the eventual outcome. Right now, independent agencies cannot issue rules without presidential approval, a director has been fired for regulatory independence, and APA procedures are being compromised. Whether courts eventually restore the status quo doesn\'t change the current assessment: independent rulemaking has been captured.',
        },
      ],
      verdict: {
        summary:
          'Independent agency rulemaking has been captured by the executive. Presidential sign-off required for all final rules, CFPB director fired for regulatory independence, and APA procedures compromised through OMB intervention.',
        keyPoints: [
  ...
  indices: {
    Drift: {
      rounds: [
        {
          prosecutor:
            'Executive order volume is 3x the historical average for this point in a presidential term. Multiple orders invoke emergency authority to bypass notice-and-comment requirements. The concentration of policy action in unilateral executive instruments — rather than legislation or agency rulemaking — represents a structural shift toward executive governance.',
          defense:
            "Executive orders are a lawful tool of presidential governance used by every modern President. Volume alone is not concerning — it reflects the President's policy priorities and urgency. Each order is subject to judicial review. Congress retains the power to legislate over any executive order.",
          arbitrator:
            "Volume combined with the use of emergency authority is more concerning than volume alone. The prosecution identifies a real pattern: governing through executive orders rather than the legislative process concentrates power even when each individual order is lawful. The defense's point about judicial review is valid but reactive. Drift is supported by the structural shift.",
        },
        {
          prosecutor:
            "Youngstown's framework addresses exactly this pattern. When the President acts unilaterally in areas where Congress has authority, even if Congress hasn't explicitly prohibited the action, we're in Justice Jackson's \"zone of twilight\" at best. The systematic preference for executive orders over legislation isn't just a style difference — it diminishes Congress's role as the primary lawmaking body.",
          defense:
            'Congressional gridlock makes executive action necessary. The President is fulfilling campaign promises through available legal tools. If Congress functioned effectively, fewer executive orders would be needed. The structural incentive for unilateral action exists in the system itself.',
          arbitrator:
            'The defense\'s "congressional gridlock" argument explains the political incentive but doesn\'t resolve the constitutional concern. Democracy requires the difficult legislative process; bypass is not a neutral alternative. The evidence supports Drift — the balance between legislative and executive action has shifted meaningfully.',
        },
      ],
      verdict: {
        summary:
          'Overall democratic health shows drift toward executive-dominated governance. Executive order volume at 3x historical norms with emergency authority invocations displaces the normal legislative process.',
        keyPoints: [
  ...
  hatch: {
    Drift: {
      rounds: [
        ...
        {
          prosecutor:
            "Letter Carriers upheld the Hatch Act because political neutrality in the civil service serves the public interest. When senior officials campaign from government platforms without consequence, it signals to the entire workforce that political activity is expected and rewarded. OSC's recommendations aren't being \"disagreed with\" — they're being ignored. The deterrent effect is the whole point of the Act, and it's gone.",
          defense:
            "The cases involve gray areas — official communications that touch on policy achievements, which inevitably overlap with campaign themes. The Hatch Act has always struggled with this line. Previous administrations also had OSC findings that didn't result in discipline. This is not new.",
          arbitrator:
            'The "gray area" defense has some merit for individual cases but doesn\'t explain the systematic pattern of non-enforcement for 47 complaints. The defense\'s "previous administrations did it too" argument, even if true, describes cumulative norm erosion rather than excusing it. Drift is supported: the Hatch Act exists but its enforcement mechanism has been effectively neutralized at the senior level.',
        },
      ],
      verdict: {
        summary:
          "Hatch Act enforcement is drifting. Record complaint volume, ignored OSC disciplinary recommendations, and senior officials mixing official duties with campaign activity have neutralized the Act's deterrent effect.",
        keyPoints: [
    ...
    Capture: {
      rounds: [
        {
          prosecutor:
            'The Hatch Act has been rendered inoperative. OSC\'s budget was cut by 60%, reducing investigators from 30 to 12. The Special Counsel position has been vacant for 4 months. Cabinet secretaries routinely use official travel and events for campaign purposes, with White House press briefings indistinguishable from campaign rallies. Federal employees report being pressured to attend "voluntary" political events organized by political appointees.',
          defense:
            'OSC budget decisions are made by Congress through appropriations. The vacancy is temporary. Individual cases of alleged violations should be reported through proper channels. The characterization of press briefings as "campaign rallies" is subjective political commentary, not evidence.',
          arbitrator:
            "The defense attributes the budget cut to Congress, but the administration requested the cut. The 4-month vacancy in the Special Counsel position, combined with the 60% budget reduction, effectively disables the enforcement body. When employees face pressure to attend political events with no functional enforcement agency to complain to, the Hatch Act's protections exist only on paper. This is capture.",
        },
        {
          prosecutor:
            'The entire enforcement architecture has been deliberately dismantled. Budget cut requested by the administration. Special Counsel position unfilled. Investigators reduced below functional capacity. Meanwhile, violations are not just tolerated but encouraged — political appointees organizing "voluntary" events that career staff understand are mandatory. The Hatch Act\'s purpose — preventing a politicized civil service — has been defeated.',
          defense:
            "Career employees retain legal protections. They can file complaints with the remaining OSC staff, appeal to the MSPB, or bring whistleblower claims. The system has redundant protections. Budget constraints affect many agencies and don't constitute targeted dismantlement.",
          arbitrator:
            'The "redundant protections" the defense cites — MSPB and whistleblower channels — are themselves under stress (as documented in the civil service and IG categories). When the primary enforcement body is gutted and the backup systems are impaired, the entire protective infrastructure fails. The evidence supports Capture: the Hatch Act cannot be enforced.',
        },
      ],
      verdict: {
        summary:
          'Hatch Act enforcement has been captured. OSC budget cut by 60%, Special Counsel position vacant, and the workforce faces political pressure with no functional enforcement mechanism.',
        keyPoints: [
  ...
  infoAvailability: {
    Drift: {
      rounds: [
        ...
        {
          prosecutor:
            'The FOIA statute, 5 U.S.C. § 552, requires agencies to make records "promptly available." Doubling response times violates this mandate. NLRB v. Robbins Tire established that FOIA serves the public\'s right to know what the government is doing. Statutory reporting requirements are not optional — they exist because Congress determined the public needs this information. Three sites down, FOIA delayed, reports missing: the pattern is clear.',
          defense:
            'Agencies are working to restore services and clear backlogs. Temporary degradation is not suppression. The administration has invested in IT modernization that may cause short-term disruption for long-term improvement. The prosecution should wait for outcomes before alleging a pattern.',
          arbitrator:
            "The defense asks for patience, which is reasonable for weeks but not for months (Oversight.gov has been down since October). The IT modernization claim should be verifiable — if true, it would significantly weaken the prosecution's case. Without evidence of modernization, the prolonged outages support the drift assessment.",
        },
      ],
      verdict: {
        summary:
          'Information availability shows drift. Extended outages of transparency-critical websites, doubled FOIA response times, and missed statutory reports degrade public access to government information.',
        keyPoints: [
    ...
    Capture: {
      rounds: [
        {
          prosecutor:
            'Government transparency infrastructure has been deliberately dismantled. Oversight.gov permanently shuttered. Federal Register publication delays of 2-3 weeks for documents the administration prefers not to publicize. FOIA processing effectively halted at DOJ, DHS, and DOD — three agencies with the highest request volumes. Agency websites are being "redesigned" with reports and datasets removed and not restored. This is information suppression at institutional scale.',
          defense:
            "Website redesigns are common during transitions. Federal Register delays reflect volume, not suppression — the Register is publishing record numbers of executive actions. FOIA backlogs are being addressed through modernization. Oversight.gov's shutdown predates this administration's decisions.",
          arbitrator:
            'The defense cannot explain the selective removal of datasets and reports during "redesigns." Federal Register delays that correlate with document sensitivity rather than volume suggest editorial control, not backlog. FOIA halts at three major agencies go beyond backlog into non-function. While Oversight.gov\'s original shutdown may have predated current policy, the decision not to restore it is a current choice. The evidence strongly supports Capture.',
        },
        {
          prosecutor:
            'The Freedom of Information Act exists because democracy requires an informed public. When the government controls what information the public can access — by shutting portals, delaying publications, halting FOIA, and removing datasets — it controls the narrative. This is not a technical issue. It is the deliberate construction of an information environment where the public sees only what the executive wants it to see.',
          defense:
            "The administration publishes more press releases, holds press conferences, and maintains social media presence than any predecessor. Information is available — it's delivered through different channels. The prosecution's preferred channels are not the only ones.",
          arbitrator:
            "Press releases and social media are executive-controlled messaging, not the transparent access to underlying records that FOIA and statutory reporting provide. The defense's argument actually illustrates the prosecution's point: replacing institutional transparency mechanisms with executive messaging is precisely information capture. The assessment is Capture.",
        },
      ],
      verdict: {
        summary:
          'Government information availability has been captured. Transparency portals shuttered, FOIA halted at major agencies, datasets removed during "redesigns," and institutional transparency replaced with executive-controlled messaging.',
        keyPoints: [
...
function makeFallbackDebate(
  category: string,
  status: StatusLevel,
  legalInfo: (typeof CATEGORY_LEGAL_MAP)[string],
): DebateResult {
  const messages: DebateMessage[] = [
    {
      role: 'prosecutor',
...
export function getDemoDebate(
  category: string,
  status: string,
  scenario: ScenarioName,
): DebateResult | { skipped: true; reason: string } {
  const resolvedStatus = (DEMO_SCENARIOS[scenario].categories[category]?.status ??
    status) as StatusLevel;
  if (resolvedStatus !== 'Drift' && resolvedStatus !== 'Capture') {
    return {
      skipped: true,
      reason: `Debate only runs for Drift or Capture categories. ${category} is ${resolvedStatus}.`,
    };
  }
  return makeDebate(category, resolvedStatus);
}

export function getDemoLegalAnalysis(
  category: string,
  status: string,
  scenario: ScenarioName,
): LegalAnalysisResult | { skipped: true; reason: string } {
  const resolvedStatus = (DEMO_SCENARIOS[scenario].categories[category]?.status ??
    status) as StatusLevel;
  if (resolvedStatus !== 'Drift' && resolvedStatus !== 'Capture') {
  ...
  const trends: KeywordTrend[] = [
    {
      ...
      category,
      currentCount: isElevated ? 12 : 3,
      baselineAvg: 4,
      ratio: isElevated ? 3.0 : 0.75,
      isAnomaly: isElevated,
      periodStart: period,
      periodEnd: period,
    },
    {
      keyword: 'compliance',
      category,
      currentCount: isElevated ? 8 : 2,
      baselineAvg: 3,
      ratio: isElevated ? 2.67 : 0.67,
      isAnomaly: isElevated,
      periodStart: period,
      periodEnd: period,
    },
    {
      keyword: 'authority',
      category,
      currentCount: isElevated ? 6 : 1,
      baselineAvg: 2,
      ratio: isElevated ? 3.0 : 0.5,
      isAnomaly: isElevated,
      periodStart: period,
      periodEnd: period,
    },
    ...
    ? [
        {
          ...
          message: `Unusual spike in "executive order" mentions in ${category}`,
          detectedAt: period,
        },
        {
          keyword: 'compliance',
          ...
          ratio: 2.67,
          severity: 'medium',
          message: `Elevated "compliance" keyword frequency in ${category}`,
          detectedAt: period,
        },
      ]
    : [];
