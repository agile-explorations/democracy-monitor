...
_Updated 2026-03-07 after Sprint R-CAL2 calibration._

| Metric                                                             | Target                                                   | Fail if                                    | Notes                                                                                                                                                                                                        |
| ------------------------------------------------------------------ | -------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Biden 2022 P1 flag rate (per category)                             | 1–15%                                                    | >20% in any category                       | Passing: worst is elections at 12.5%                                                                                                                                                                         |
| Biden 2022 P2 confirmation rate (of flagged)                       | 8–70%                                                    | >70% or <8%                                | Lowered from 10% floor — baseline periods have very few genuinely concerning docs; P2 correctly rejects most                                                                                                 |
| Biden 2022 weeks at Elevated+ (categories ≥20 avg docs/week)       | ≤5%                                                      | >5% of weeks Elevated+                     | Passing after R-CAL2 fixes (L2 P2-corroboration, L3 reinforcement-only)                                                                                                                                      |
| Biden 2022 weeks at Elevated+ (categories <20 avg docs/week)       | ≤10%                                                     | >10% of weeks Elevated+                    | Higher threshold for thin categories — structural z-scores are inherently noisy with small samples. judicialIndependence (23.1%, 6 docs/week) is a documented known limitation; see FUTURE_ROADMAP.md §R-F12 |
| Biden 2021 transition week P1 flag rate                            | Higher than steady state, but lower than Trump T2 week 1 | Comparable to or exceeding Trump T2 week 1 | Passing: 2.2% vs 5.0%                                                                                                                                                                                        |
| Trump T2 P2 clearly*concerning rate \_outside known-event windows* | <10% of documents                                        | >15% — system flagging routine governance  | Passing: 9.8%                                                                                                                                                                                                |
| Trump T2 P1 "routine" rate (all weeks including events)            | >60% of documents classified routine                     | <50% — everything looks concerning         | Passing: 97.1%                                                                                                                                                                                               |
...
_Updated 2026-03-07 after Sprint R-CAL2._

| Layer               | Status                            | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| L1 (Structural)     | **Ready** — with known limitation | Structural scores populated for all categories. Thin categories (<20 docs/week: judicialIndependence, elections, immigrationEnforcement) produce noisy z-scores — accepted with higher NC-3 threshold (10%). Per-category adaptive thresholds deferred to R-F12.                                                                                                                                                                           |
| L2 (AI Assessment)  | **Ready**                         | P1 flag rate 1-15% across all Biden categories. P2 corroboration requirement added (R-CAL2) — L2 no longer fires on P1 alone when P2 found nothing concerning. Content gate (≥100 chars) prevents garbage assessments.                                                                                                                                                                                                                     |
| L3 (Thematic Drift) | **Reinforcement-only**            | Set to reinforcement-only mode (R-CAL2): can upgrade L1/L2 signals (Elevated → Divergent) but cannot independently trigger Elevated. Empirical finding: 23 false positive weeks in Biden 2022, 0 independent true detections. Root cause: baseline centroids computed from contaminated embeddings (now cleaned). Re-evaluate as independent signal after next full baseline recomputation with clean data — see FUTURE_ROADMAP.md §R-F13. |
| Convergence         | **Ready**                         | L1+L2 scores populated in weekly_aggregates. L3 contributes as reinforcement. Biden periods pass NC-3 for categories ≥20 docs/week. Convergence formula produces Stable/Elevated/Divergent/ConfirmedConcern as designed.                                                                                                                                                                                                                   |
