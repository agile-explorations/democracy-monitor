...
- Sprint R-CPD1: CPD source swap — replace WH scraper + GDELT rhetoric proxy with GovInfo CPD (Compilation of Presidential Documents). NARA subject metadata for direct category routing (eliminates crossfeed pipeline). ACTIVE_SOURCES constant for pipeline source filtering. 5 analysis periods (~5,200 CPD docs). Issues #239-#246.
