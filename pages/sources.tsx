        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-6 space-y-6 text-sm text-slate-700">
            <section>
              ...
              <p className="mb-4">
                Each category monitors specific data signals from government agencies, watchdog
                organizations, and official publications.
              </p>
                      ...
                      {cat.signals.map((signal, i) => (
                        <div key={i} className="flex items-start gap-2 text-xs">
                          ...
                          <div>
                            ...
                            {signal.note && (
                              <span className="text-slate-400 ml-1">— {signal.note}</span>
                            )}
                          </div>
                        </div>
                      ))}
            ...
            <section>
              ...
              <p className="mb-4">
                The dashboard monitors {MONITORED_SITES.length} government websites for
                availability, checking each site hourly.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {MONITORED_SITES.map((site) => (
                  ...
                  >
                    <span
                      className={`w-2 h-2 rounded-full ${site.critical ? 'bg-red-400' : 'bg-slate-400'}`}
                    />
              ...
              <p className="text-xs text-slate-400 mt-2">
                Red dots indicate critical sites whose downtime significantly impacts assessments.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    Custom scrapers for democracy watchdog trackers (Brookings, NAACP LDF, etc.)
                  </span>
                </div>
              </div>
            </section>
