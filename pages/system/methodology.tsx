    ...
    <>
      ...
      <Section title="Detection Architecture" id="detection-architecture">
        ...
        <p>
          ...
          swap audit that tests whether names alone move a verdict, are published on{' '}
          <Link href="/system/self-tests" className="text-dm-accent hover:underline">
            what happens when we test ourselves
          </Link>
          . Both passes receive up to 8,000 characters of boilerplate-stripped content. Pass 2 also
          receives week-level context including peer document titles and flag rate trajectory.
          Documents are classified from routine to clear departure (internal value:
          clearly_concerning).
        </p>
        <p>
  ...
  return (
    <>
      ...
      <Section title="AI Document Review (Active Detection)" id="ai-document-review">
        ...
        <p>
          The reviewer is tested rather than trusted: its verdict rates for every era, the
          administration-swap audit, and the outside-reader audit are published together on{' '}
          <Link href="/system/self-tests" className="text-dm-accent hover:underline">
            what happens when we test ourselves
          </Link>
          .
